...
const TicketInfo = ({ id, app, issue, date, status, openedBy, devMode, handleToggleTicketStatus }) => {    
    ...
    return (
        <div>
            <h4><span className="text-muted">Ticket# {id}</span></h4>
            <h4><span className="text-muted">Opened By:</span> {openedBy}</h4>
            <h4><span className="text-muted">Opened Date:</span> {date}</h4>
            <h4><span className="text-muted">App:</span> {app}</h4>
            <h4><span className="text-muted">Status:</span> {status}</h4>
