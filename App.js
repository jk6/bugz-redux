...
class App extends Component {
  ...
  loadData (){ 
    this.props.loadFetchUser(`${process.env.API_PATH}/user`);
    this.props.loadFetchApps(`${process.env.API_PATH}/apps`);
    this.props.loadFetchTickets(`${process.env.API_PATH}/tickets`);
    this.props.loadFetchComments(`${process.env.API_PATH}/comments`);
  }
